<nav>
	<div class="nav-wrapper greyperso">
		...
		<ul class="side-nav left-aligned" id="mobile-demo">
			...
			<?php if(isLogged()){ ?><li><a class="waves-effect waves-light btn" href="Administrateur.php"><i class="large material-icons">supervisor_account</i>Administrateur</a></li><?php } ?>
